...
public class OI {
  ...
  // Button button = new JoystickButton(stick, buttonNumber);
    public OI(){
      ...
      //----------Joystick2-------------
      Button lvl2=new JoystickButton(Robot.joy2, RobotMap.hatchlvl2);
      lvl2.whileHeld(new MoveArmTo(LifterMode.Hatchlvl2));

      Button pickup=new JoystickButton(Robot.joy2, RobotMap.pickup);
      pickup.whileHeld(new MoveArmTo(LifterMode.PickUp));

      Button lvl3=new JoystickButton(Robot.joy2, RobotMap.hatchlvl3);
      lvl3.whileHeld(new MoveArmTo(LifterMode.Hatchlvl3));

      Button hatch = new JoystickButton (Robot.joy2, RobotMap.hatchOpenClose);
