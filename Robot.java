...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    //methods make sure that encoders are initialized to correct positions
  ...
  public void autonomousPeriodic() {
    ...
    Robot.drivebase.arcadeDrive(Robot.joy.getRawAxis(1), Robot.joy.getRawAxis(2)*RobotMap.reverse);
